function make_website(resume_json)
{
    ...
    resume_json.phone_numbers.forEach( number => {
        contact_details_list.push(`<i class="fa-solid fa-mobile-screen"></i> ${number} | <i class="fa-solid fa-location-dot"></i> ${resume_json.location}`);
    });
